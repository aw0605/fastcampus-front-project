...
describe("Accordion 컴포넌트 기능 테스트", () => {
  it("Accordion 버튼 클릭 시, Panel이 펼쳐지는지 확인", async () => {
    const args = {
      items: [
        {
          name: "목록1",
  ...
  it("두번째 Accordion 버튼 클릭 시, 해당 Panel만 펼쳐지는지 확인", async () => {
    const args = {
      items: [
        {
          name: "목록1",
  ...
  it("활성화 된 Accordion 버튼 클릭 시 Panel 접히는지 확인", async () => {
    const args = {
      items: [
        {
          name: "목록1",
  ...
  it("defaultActiveItems에 itemName이 있을 경우, 초기 렌더링 시 Panel 펼쳐져 있는지 확인", async () => {
    const args = {
      items: [
        {
          name: "목록1",
